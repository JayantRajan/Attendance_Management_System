...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CSE","BSC","BCOM","ECE","EEE")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","B.Tech","FE","TE","BE","MS")
        cou_combo.current(0)
...
# ==================Function Decleration==============================
    ...
    def fetch_data(self):
        conn = mysql.connector.connect(username='root', password='admin', host='localhost', database='face_recognition',
                                       port=3306)
        mycursor = conn.cursor()
