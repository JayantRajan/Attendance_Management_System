...
class Face_Recognition:
    ...
    def mark_attendance(self,i,r,n):
        with open("attendance.csv","r+",newline="\n") as f:
            ...
            if((i not in name_list and i is not None)) and ((r not in name_list and r is not None)) and ((n not in name_list and n is not None)):
                now=datetime.now()
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in featuers:
                ...
                if confidence > 77 and i is not None:
